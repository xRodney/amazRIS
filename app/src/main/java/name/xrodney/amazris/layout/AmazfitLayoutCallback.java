...
package name.xrodney.amazris.layout;
 ...
 *
 * This is a modification of @{@link android.support.wear.widget.CurvingLayoutCallback} -
 * Amazfit Pace framework does not have isScreenRound method, so it is set to true forcibly.
 */
public class AmazfitLayoutCallback extends WearableLinearLayoutManager.LayoutCallback {
    ...
    public AmazfitLayoutCallback(Context context) {
        mCurvePath = new Path();
